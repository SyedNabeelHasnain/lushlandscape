...
<div x-data="mediaPickerModal({!! $fieldKeyExpression !!}, {!! $modelExpression !!} || null, '')"
    ...
    <div class="w-16 h-16 rounded-lg border border-gray-200 bg-white flex items-center justify-center overflow-hidden shrink-0">
        ...
        <i x-show="!previewUrl" data-lucide="image" class="w-6 h-6 text-gray-300"></i>
    </div>
    ...
    <div class="flex-1 space-y-2">
        <div class="flex flex-col gap-2 sm:flex-row">
            ...
            <button type="button" x-show="fieldId" @click="clear(); {!! $modelExpression !!} = null" class="px-3 py-1.5 border border-gray-200 rounded-lg text-xs text-gray-500 hover:bg-gray-50 transition">
                Remove
            </button>
        </div>
    ...
    <div x-show="open" x-cloak class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60" @keydown.escape.window="open = false">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col" @click.stop>
            ...
            <div x-show="tab === 'library'" class="flex-1 overflow-hidden flex flex-col min-h-[400px]">
                ...
                <div class="flex-1 overflow-y-auto p-4">
                    ...
                    <div x-show="!loading && assets.length === 0" class="text-center py-12 text-sm text-gray-400">No media found.</div>
                    <div x-show="!loading && assets.length > 0" class="grid grid-cols-2 gap-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6">
            ...
            <div x-show="tab === 'upload'" class="flex-1 overflow-y-auto p-4 min-h-[400px] sm:p-6">
