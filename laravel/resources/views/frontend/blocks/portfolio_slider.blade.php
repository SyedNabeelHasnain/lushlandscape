    ...
    <div class="portfolio-pin-wrapper w-full lg:h-screen flex flex-col justify-center py-20 lg:py-0">
        ...
        <div id="portfolio-track" class="mobile-swipe flex gap-5 lg:gap-10 px-6 lg:px-12 w-full lg:w-max no-scrollbar">
            @for($i = 1; $i <= 4; $i++)
                ...
                <div class="mobile-swipe-item w-[85vw] sm:w-[50vw] lg:w-[35vw] flex-shrink-0 group cursor-pointer gs-reveal {{ $i == 4 ? 'lg:pr-12' : '' }}">
                    ...
                    <div class="flex justify-between items-start">
                        ...
                        <i class="fa-solid fa-arrow-right text-forest-light -rotate-45 group-hover:rotate-0 transition-transform duration-500 mt-2"></i>
                    </div>
                </div>
                @endif
            @endfor
