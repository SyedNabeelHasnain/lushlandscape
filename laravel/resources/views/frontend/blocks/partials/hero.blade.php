{{-- Block: hero --}}
@php
    $heroHeading = !empty($content['heading']) ? $content['heading'] : (($context['city_name'] ?? null) ? 'Landscaping Services in '.($context['city_name'] ?? '').', Ontario' : "Ontario's Trusted Landscaping Contractors");
    ...
    $eyebrow = !empty($content['eyebrow']) ? $content['eyebrow'] : (($context['city_name'] ?? null) ? ($context['city_name'] ?? '').', '.($context['province_name'] ?? 'Ontario') : '');
