            ...
            <div class="lg:col-span-3 bg-white border border-stone p-8">
                ...
                <div x-data="contactForm('quote-form', 'request-quote')" x-cloak>
                    <form x-on:submit.prevent="submitForm" id="quote-form">
                        ...
                        <input type="hidden" name="pre_service" value="{{ request('service','') }}">
                        <input type="hidden" name="pre_city" value="{{ request('city','') }}">
                        @endif
                        ...
                        <button type="submit" :disabled="formSubmitting || (requiresVerification && !emailVerified)"
                            ...
                            <span x-show="!formSubmitting">Request a Consultation</span>
