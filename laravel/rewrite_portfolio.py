...
# Add scaffoldPortfolioCategories method
scaffold_portfolio_categories = """
...
content = re.sub(r'    private function scaffoldBlogCategories', scaffold_portfolio_categories + "\n    private function scaffoldBlogCategories", content)

# Add portfolio_projects to scaffoldTaxonomyPages
scaffold_taxonomies = """
...
# Rewrite Portfolio Index, Category, Project
new_portfolio_methods = """
...
content = re.sub(r'    private function buildPortfolioIndex\(\): array\n    \{.*?(?=    private function buildBlogIndex|\Z)', new_portfolio_methods + "\n\n", content, flags=re.DOTALL)
content = re.sub(r'    public function buildPortfolioCategory\(\\App\\Models\\PortfolioCategory \$category\): array\n    \{.*?(?=    public function buildBlogCategory|\Z)', '', content, flags=re.DOTALL)


with open(file_path, 'w') as f:
    f.write(content)
print("Updated portfolio methods successfully.")
