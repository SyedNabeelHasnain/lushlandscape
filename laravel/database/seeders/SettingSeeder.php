...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = array_merge($settings, [
            ...
            ['group' => 'theme', 'key' => 'theme_primary_color',    'value' => '#153823', 'type' => 'color', 'label' => 'Primary Color (Deep Green)'],
            ['group' => 'theme', 'key' => 'theme_primary_light',    'value' => '#2A462A', 'type' => 'color', 'label' => 'Primary Light (Brand Green)'],
            ['group' => 'theme', 'key' => 'theme_primary_dark',     'value' => '#0f2819', 'type' => 'color', 'label' => 'Primary Dark'],
            ['group' => 'theme', 'key' => 'theme_accent_color',     'value' => '#A47148', 'type' => 'color', 'label' => 'Accent Color (Brand Brown)'],
            ['group' => 'theme', 'key' => 'theme_text_color',       'value' => '#111111', 'type' => 'color', 'label' => 'Text Color (Ink)'],
            ['group' => 'theme', 'key' => 'theme_text_secondary',   'value' => 'rgba(17, 17, 17, 0.7)', 'type' => 'color', 'label' => 'Secondary Text Color'],
            ...
            ['group' => 'theme', 'key' => 'theme_bg_secondary',     'value' => '#F6F9F6', 'type' => 'color', 'label' => 'Secondary Background Color (Airy Green)'],
            ['group' => 'theme', 'key' => 'theme_bg_dark',          'value' => '#153823', 'type' => 'color', 'label' => 'Dark Background Color'],
            ['group' => 'theme', 'key' => 'theme_border_color',     'value' => '#DADDD8', 'type' => 'color', 'label' => 'Border / Divider Color (Stone)'],
            ['group' => 'theme', 'key' => 'theme_link_color',       'value' => '#153823', 'type' => 'color', 'label' => 'Link Color'],
            ['group' => 'theme', 'key' => 'theme_link_hover_color', 'value' => '#A47148', 'type' => 'color', 'label' => 'Link Hover Color'],
            ['group' => 'theme', 'key' => 'theme_surface_gradient_start', 'value' => '#E4ECE4', 'type' => 'text', 'label' => 'Section Gradient Start (Airy)'],
            ['group' => 'theme', 'key' => 'theme_surface_gradient_end', 'value' => '#F6F9F6', 'type' => 'text', 'label' => 'Section Gradient End (Airy)'],
            ...
            ['group' => 'theme', 'key' => 'theme_btn_primary_bg',   'value' => '#2A462A', 'type' => 'color', 'label' => 'Button Primary BG Color'],
            ['group' => 'theme', 'key' => 'theme_btn_primary_text', 'value' => '#ffffff', 'type' => 'color', 'label' => 'Button Primary Text Color'],
            ['group' => 'theme', 'key' => 'theme_btn_radius',       'value' => '0.125rem', 'type' => 'text', 'label' => 'Button Border Radius (e.g. 0.125rem)'],
            ['group' => 'theme', 'key' => 'theme_btn_secondary_border', 'value' => '#153823', 'type' => 'color', 'label' => 'Button Secondary Border Color'],
            ['group' => 'theme', 'key' => 'theme_card_radius',         'value' => '0rem', 'type' => 'text', 'label' => 'Card Radius'],
            ['group' => 'theme', 'key' => 'theme_panel_radius',        'value' => '0.75rem', 'type' => 'text', 'label' => 'Panel Radius'],
            ['group' => 'theme', 'key' => 'theme_card_border_color',   'value' => 'rgba(17, 17, 17, 0.05)', 'type' => 'color', 'label' => 'Card Border Color'],
            ['group' => 'theme', 'key' => 'theme_card_hover_border_color', 'value' => '#A47148', 'type' => 'color', 'label' => 'Card Hover Border Color'],
            ['group' => 'theme', 'key' => 'theme_form_input_bg',       'value' => 'transparent', 'type' => 'color', 'label' => 'Form Input Background'],
            ['group' => 'theme', 'key' => 'theme_form_input_border',   'value' => 'rgba(42, 70, 42, 0.15)', 'type' => 'color', 'label' => 'Form Input Border'],
            ['group' => 'theme', 'key' => 'theme_form_focus_color',    'value' => '#2A462A', 'type' => 'color', 'label' => 'Form Focus Accent'],
            ['group' => 'theme', 'key' => 'theme_section_padding',     'value' => 'clamp(5rem, 8vw, 8rem)', 'type' => 'text', 'label' => 'Section Vertical Padding'],
